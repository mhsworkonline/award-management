-- Reconciled from supabase_migrations.schema_migrations (version 20260820090044).

alter table am_public_submissions alter column percentage drop not null;
alter table am_public_submissions alter column grade drop not null;
alter table am_public_submissions add constraint am_public_submissions_grade_or_pct_ck
  check (percentage is not null or grade is not null);
