-- Reconciled from supabase_migrations.schema_migrations (version 20260820092712).

alter table am_public_submissions add column if not exists medium_id uuid references am_mediums(id) on delete set null;

alter table am_public_submissions add constraint am_public_submissions_medium_ck check (
  standard_id is null or medium_id is not null
);
...
drop function if exists am_submit_public_application(uuid,uuid,text,text,text,text,text,text,uuid,text,uuid,text,uuid,uuid,text,text,int,text,numeric,text,text,text);
...
revoke all on function am_submit_public_application(uuid,uuid,text,text,text,text,text,text,uuid,text,uuid,text,uuid,uuid,uuid,text,text,int,text,numeric,text,text,text) from public;
grant execute on function am_submit_public_application(uuid,uuid,text,text,text,text,text,text,uuid,text,uuid,text,uuid,uuid,uuid,text,text,int,text,numeric,text,text,text) to anon, authenticated;
